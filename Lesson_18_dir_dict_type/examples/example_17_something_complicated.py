import inspect
import example_3_dir
from pprint import pprint

for name, data in inspect.getmembers(example_3_dir):
...
for key, data in inspect.getmembers(example_3_dir, inspect.isclass):
...
pprint(inspect.getmembers(example_3_dir.MyClass, inspect.isfunction))
print("------------------------------------------------------------")

# За допомогою модулю inspect можна відстежувати усі екземпляри класу, які створені у програмі, за допомогою одного
# виклику функції:
m_c = example_3_dir.MyClass(surname='Petrenko', name='Ivan', age=23)
...
print(example_3_dir.MyClass.__doc__)
print("------------------------------------------------------------")
print('getdoc(MyClass):')
print(inspect.getdoc(example_3_dir.MyClass))
print("------------------------------------------------------------")
